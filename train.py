#This version ran in lab with successfull car dataset
...
print('I am here', torch.cuda.is_available())
...
if __name__ == '__main__':
    # This is the recommended way to safeguard the entry point of the program.
    main()